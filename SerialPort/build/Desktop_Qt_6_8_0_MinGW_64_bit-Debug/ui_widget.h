...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        close_port->setObjectName("close_port");
        ...
        Receive_text_window->setObjectName("Receive_text_window");
        ...
        clear_button2->setObjectName("clear_button2");

        horizontalLayout_7->addWidget(clear_button2);

        receive_modl = new QPushButton(Widget);
        receive_modl->setObjectName("receive_modl");
        ...
        send_text_window->setObjectName("send_text_window");
        ...
        clear_button_1->setObjectName("clear_button_1");

        horizontalLayout_6->addWidget(clear_button_1);

        send_modl = new QPushButton(Widget);
        send_modl->setObjectName("send_modl");
